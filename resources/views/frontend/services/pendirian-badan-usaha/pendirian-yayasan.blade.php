...
<section class="requirements-section">
    <div class="container">
        <div class="section-header">
            ...
            <h2>PERSYARATAN DOKUMEN YAYASAN</h2>
            ...
            <div class="col-md-6">
                <div class="requirement-card">
                    ...
                    <ul class="requirement-list">
                        ...
                        <li><i class="fa-solid fa-circle-check"></i> Alamat lengkap yayasan</li>
                        <li><i class="fa-solid fa-circle-check"></i> Maksud & tujuan yayasan</li>
                        <li><i class="fa-solid fa-circle-check"></i> Susunan pengurus (Pembina, Pengawas, Pengurus)</li>
                        <li><i class="fa-solid fa-circle-check"></i> Kekayaan awal yayasan</li>
                    </ul>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="pricing-card">
                    ...
                    <a href="https://wa.me/628123456789?text=Halo%20saya%20tertarik%20Paket%20PREMIUM%20Yayasan" class="btn-pricing">Pilih Paket Premium</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="pricing-card featured">
                    ...
                    <a href="https://wa.me/628123456789?text=Halo%20saya%20tertarik%20Paket%20EKSKLUSIF%20Yayasan" class="btn-pricing-primary">Pilih Paket Eksklusif</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="pricing-card">
                    ...
                    <a href="https://wa.me/628123456789?text=Halo%20saya%20tertarik%20Paket%20ENTERPRISE%20Yayasan" class="btn-pricing">Pilih Paket Enterprise</a>
                </div>
            </div>
        </div>
    </div>
