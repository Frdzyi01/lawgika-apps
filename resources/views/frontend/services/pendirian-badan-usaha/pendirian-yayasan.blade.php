...
<section class="pt-solution">
    <div class="container">
        <div class="row align-items-center g-5 flex-row-reverse">
            ...
            <div class="col-lg-6">
                <img loading="lazy" src="https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&auto=format" alt="Foundation Social Activity" class="img-fluid-rounded">
            </div>
        </div>
    </div>
</section>
...
{{-- ===== PERSYARATAN DOKUMEN YAYASAN ===== --}}
<section class="requirements-section">
    <div class="container">
        <div class="section-header">
            <span class="badge" data-i18n="ui.req.doc_prep">Persiapan Dokumen</span>
            <h2 data-i18n="yayasan.req_title" data-i18n="yayasan.req_title">PERSYARATAN DOKUMEN YAYASAN</h2>
            <p data-i18n="ui.req.doc_prep_desc" data-i18n="ui.req.doc_prep_desc">Siapkan berkas berikut, tim kami akan memprosesnya</p>
        </div>
        <div class="row g-4 justify-content-center">
            <div class="col-md-6">
                <div class="requirement-card">
                    ...
                    <ul class="requirement-list">
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.name_yayasan">Nama Yayasan (minimal 3 kata)</span></li>
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.address_yayasan">Alamat lengkap yayasan</span></li>
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.purpose_yayasan">Maksud & tujuan yayasan</span></li>
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.management_yayasan">Susunan pengurus (Pembina, Pengawas, Pengurus)</span></li>
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.initial_assets_yayasan">Kekayaan awal yayasan</span></li>
                    </ul>
...
{{-- ===== PRICING TABLE YAYASAN (SESUAI FOTO) ===== --}}
<section class="pt-pricing" id="pricing">
    <div class="container">
        <div class="section-title text-center mb-5">
            <span class="subtitle" data-i18n="ui.pricing.pkg_choice_yayasan">Pilihan Paket Yayasan</span>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="pricing-card">
                    ...
                    <ul class="feature-list">
                        <li><i class="fa-solid fa-check"></i> <span data-i18n="ui.pricing.feature.check_name_yayasan">Pengecekan Nama Yayasan</span></li>
                        <li><i class="fa-solid fa-check"></i> <span data-i18n="ui.pricing.feature.book_name_yayasan">Pemesanan Nama Yayasan</span></li>
                        <li><i class="fa-solid fa-check"></i> <span data-i18n="ui.pricing.feature.deed_yayasan">Akta Pendirian Yayasan</span></li>
                    ...
                    <button onclick="goOrder('yayasan','premium')" class="btn-pricing w-100" data-i18n="ui.pricing.choose_basic">Pilih Basic Package</button>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-md-6">
                <div class="pricing-card featured">
                    ...
                    <button onclick="goOrder('yayasan','enterprise')" class="btn-pricing-primary w-100" data-i18n="ui.pricing.choose_business">Pilih Business Package</button>
                </div>
            </div>
        </div>
    </div>
