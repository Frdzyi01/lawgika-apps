        ...
        <div class="page-heading">
            <div class="page-header-left">
                ...
                <ul
                    ...
                    <li>Layanan Pendirian PT Perorangan</li>
                </ul>
            </div>
            <div
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="section-title">
                            <span class="wow fadeInUp">Jasa Pendirian PT Perorangan</span>
                            <h2
                                class="wow fadeInUp"
                                data-wow-delay=".3s">
                                Jasa Konsultan Legalitas & Pendirian Usaha Terpercaya.
                            </h2>
                        </div>
                        <p
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                <div class="pricing-items style-2">
                    <h6 class="top-text">PENDIRIAN PT PERORANGAN</h6> <br>
                    ...
                    <ul class="pricing-list">
                        ...
                        <li><span><i class="fa-solid fa-check"></i> Pernyataan Pendaftaran</span></li>
                        <li><span><i class="fa-solid fa-check"></i> Sertifikat Pendaftaran Menkumham</span></li>
                        <li><span><i class="fa-solid fa-check"></i> NPWP & SKT</span></li>
                    ...
                    <p class="mt-4 text-start">Layanan Pendirian PT Perorangan menjangkau seluruh Indonesia</p>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                <div class="pricing-items style-2 active">
                    <h6 class="top-text">PENDIRIAN PT PERORANGAN + VO</h6> <br>
                    <div class="pricing-header-2">
                        <h2>Rp 6.000.000</h2>
                    </div>
                    <ul class="pricing-list">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                <div class="pricing-items style-2">
                    <h6 class="top-text" style="font-size: 14px !important;">PENDIRIAN PT PERORANGAN + VO + CALL HANDLING</h6>
                    <br>
                    <div class="pricing-header-2">
                        <h2>Rp 8.000.000</h2>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="faq-content">
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                Pertanyaan Seputar Legalitas & Pendirian PT Perorangan
                            </h2>
                        </div>
                            ...
                            <div class="accordion" id="accordion">
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Proses pendirian PT Perorangan relatif lebih cepat, biasanya hanya memakan waktu 3 sampai 7 hari kerja setelah persyaratan dokumen lengkap dan pendaftaran elektronik di Kemenkumham disetujui.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div id="faq2" class="accordion-collapse show" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Syarat utamanya sangat sederhana, hanya meliputi e-KTP dan NPWP dari 1 (satu) orang pendiri yang sekaligus akan bertindak sebagai direktur dan pemegang saham 100%.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".7s">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" aria-expanded="false" aria-controls="faq3">
                                            Apakah pendiriannya menggunakan Akta Notaris?
                                        </button>
                                    </h5>
                                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Tidak. Berbeda dengan badan usaha lain, PT Perorangan didirikan cukup dengan membuat Surat Pernyataan Pendirian yang didaftarkan langsung ke sistem AHU Kemenkumham tanpa melalui pengesahan Notaris.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".7s">
                                    ...
                                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Perbedaan utamanya adalah PT Perorangan khusus didirikan oleh 1 orang saja (pendiri tunggal), status usahanya untuk kriteria Mikro & Kecil (UMK), dan tidak mewajibkan akta notaris, sedangkan PT biasa butuh minimal 2 orang pendiri dan melalui notaris.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="testimonial-card-items-2">
                        ...
                        <div class="client-info">
                            ...
                            <div class="content">
                                <h4>Esther Howard</h4>
                                <span>Direktur PT Perorangan</span>
                            </div>
                        </div>
                        <p>
                            Praesent ut lacus a velit tincidunt aliquam
