@extends('layout.app')
@section('title', 'Pendirian Firma | Lawgika - Konsultan Legal & Bisnis')
@section('meta_description', 'Layanan Pendirian Firma terbaik dan terpercaya di Indonesia oleh Lawgika.co.id. Proses cepat, legal, dan aman untuk kebutuhan bisnis Anda.')
@section('meta_keywords', 'Pendirian Firma, Jasa Pendirian Firma, Konsultan Pendirian Firma, Lawgika, Legalitas Usaha, Jasa Hukum Bisnis')
...
<section class="pt-solution">
    <div class="container">
        <div class="row align-items-center g-5 flex-row-reverse">
            ...
            <div class="col-lg-6">
                <img loading="lazy" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&auto=format" alt="Business Partnership Meeting" class="img-fluid-rounded">
            </div>
        </div>
    </div>
</section>
...
<section class="requirements-section">
    <div class="container">
        <div class="section-header">
            ...
            <h2 data-i18n="firma.req_title" data-i18n="firma.req_title">PERSYARATAN DOKUMEN FIRMA</h2>
