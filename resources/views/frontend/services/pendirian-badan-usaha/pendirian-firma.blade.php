                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="section-title">
                            <span class="wow fadeInUp">Jasa Pendirian Firma</span>
                            <h2
                                class="wow fadeInUp"
                                data-wow-delay=".3s">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                <div class="pricing-items style-2">
                    <h6 class="top-text">PENDIRIAN FIRMA</h6>
                    <div class="pricing-header-2">
                        <h2>Rp 5.000.000</h2>
                    </div>
                    <ul class="pricing-list">
                        <li><span><i class="fa-solid fa-check"></i> Pengecekan Nama Firma</span></li>
                        <li><span><i class="fa-solid fa-check"></i> Pemesanan Nama Firma</span></li>
                        <li><span><i class="fa-solid fa-check"></i> Akta Pendirian Firma</span></li>
                    ...
                    <p class="mt-4 text-start">Layanan Pendirian Firma area tertentu (Jabodetabek/Medan/Batam)</p>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                <div class="pricing-items style-2 active">
                    <h6 class="top-text">PENDIRIAN FIRMA + VO</h6>
                    <div class="pricing-header-2">
                        <h2>Rp 7.500.000</h2>
                    </div>
                    <ul class="pricing-list">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                <div class="pricing-items style-2">
                    <h6 class="top-text">PENDIRIAN FIRMA + VO + CALL HANDLING</h6>
                    <br>
                    <div class="pricing-header-2">
                        <h2>Rp 10.000.000</h2>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="faq-content">
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                Pertanyaan Seputar Legalitas & Pendirian Firma
                            </h2>
                        </div>
                            ...
                            <div class="accordion" id="accordion">
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Proses pendirian Firma biasanya memakan waktu sekitar 3 sampai 7 hari kerja setelah semua dokumen persyaratan lengkap dan nama Firma telah disetujui.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div id="faq2" class="accordion-collapse show" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Secara umum, persyaratan dokumen meliputi fotokopi e-KTP dan NPWP para pendiri (minimal 2 orang: Partner/Sekutu Firma), surat keterangan domisili usaha, serta surat pernyataan modal.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".7s">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" aria-expanded="false" aria-controls="faq3">
                                            Apakah Firma bisa didirikan tanpa NPWP perusahaan?
                                        </button>
                                    </h5>
                                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Tidak bisa. NPWP perusahaan menjadi salah satu syarat mutlak setelah Akta Notaris diterbitkan agar Firma bisa sah beroperasi dan membayar pajak perusahaan. Kami akan membantu pengurusannya.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".7s">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq4" aria-expanded="false" aria-controls="faq4">
                                            Apa bedanya PT dan Firma?
                                        </button>
                                    </h5>
                                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Perbedaan mendasar adalah jika terjadi kerugian, setiap Partner/Sekutu Firma bertanggung jawab penuh hingga harta pribadi, tidak ada pemisahan tanggung jawab seperti pada bentuk badan usaha lainnya.
                                        </div>
                                    </div>
                                </div>
                            </div>
