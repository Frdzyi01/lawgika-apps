...
<section class="requirements-section">
    <div class="container">
        <div class="section-header">
            ...
            <h2 data-i18n="pt.req_title" data-i18n="pt.req_title">PERSYARATAN DOKUMEN PT</h2>
            ...
            <div class="col-md-6">
                <div class="requirement-card">
                    ...
                    <ul class="requirement-list">
                        ...
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.shareholders">Struktur pemegang saham</span></li>
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.management">Susunan direksi & komisaris</span></li>
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.capital">Modal dasar, modal ditempatkan, modal disetor</span></li>
                    </ul>
            ...
            <div class="col-md-6">
                <div class="requirement-card">
                    ...
                    <ul class="requirement-list">
                        ...
                        <li><i class="fa-solid fa-circle-check"></i> <span data-i18n="ui.req.proof_address">Bukti alamat perusahaan</span></li>
                    </ul>
...
<section class="pt-pricing" id="pricing">
    <div class="container">
        <div class="section-title text-center mb-5">
            <span class="subtitle" data-i18n="ui.pricing.pkg_choice">Pilihan Paket PT</span>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="pricing-card">
                    ...
                    <ul class="feature-list">
                        ...
                        <li><i class="fa-solid fa-check"></i> <span data-i18n="ui.pricing.feature.deed_pt">Akta Pendirian PT</span></li>
                    ...
                    <button onclick="goOrder('pendirian-PT','premium')" class="btn-pricing w-100" data-i18n="ui.pricing.choose_basic">Pilih Basic Package</button>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-md-6">
                <div class="pricing-card featured">
                    ...
                    <button onclick="goOrder('pendirian-PT','enterprise')" class="btn-pricing-primary w-100" data-i18n="ui.pricing.choose_business">Pilih Business Package</button>
                </div>
            </div>
        </div>
    </div>
