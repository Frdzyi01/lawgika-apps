...
<div class="col-lg-5 col-md-6">
    ...
    .start-text {
        ...
        <button onclick="goOrder('pendirian-PT','premium')" class="btn-pricing w-100">
            Pilih Basic Package
        </button>
    </div>
</div>
...
<div class="col-lg-5 col-md-6">
    <div class="pricing-card featured">
        ...
        <div class="price">
            <span class="start-text">start form</span> Rp 9.300.000
        </div>
        ...
        <button onclick="goOrder('pendirian-PT','enterprise')" class="btn-pricing-primary w-100">
