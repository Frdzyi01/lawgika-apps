...
<style>
    ...
    .hero-agency {
        height: 85vh;
        min-height: 600px;
        background: url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=2000') center center / cover no-repeat; /* Ganti: Analytics & Reporting Dashboard */
        position: relative;
        display: flex;
        align-items: center;
        margin-top: 0;
    ...
    .visual-break-agency {
        ...
        background: linear-gradient(90deg, rgba(0, 0, 0, 0.85) 0%, rgba(0, 0, 0, 0.4) 60%, transparent 100%),
            url('https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&q=80&w=2000') center center / cover no-repeat fixed; /* Ganti: Business Report */
        position: relative;
        overflow: hidden;
    }
