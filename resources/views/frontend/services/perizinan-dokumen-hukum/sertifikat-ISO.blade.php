@extends('layout.app')
@section('title', 'Sertifikat Iso | Lawgika - Konsultan Legal & Bisnis')
@section('meta_description', 'Layanan Sertifikat Iso terbaik dan terpercaya di Indonesia oleh Lawgika.co.id. Proses cepat, legal, dan aman untuk kebutuhan bisnis Anda.')
@section('meta_keywords', 'Sertifikat Iso, Jasa Sertifikat Iso, Konsultan Sertifikat Iso, Lawgika, Legalitas Usaha, Jasa Hukum Bisnis')
...
<section id="iso-details" class="section-padding overflow-hidden">
    <div class="container">
        ...
        <div class="row align-items-center mb-5 pb-lg-5">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="zigzag-image-container">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&q=80&w=1000" class="w-100" alt="Sertifikasi ISO 9001">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row align-items-center flex-row-reverse">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="zigzag-image-container">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=1000&q=80" class="w-100" alt="ISO Lainnya">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="zigzag-text">
