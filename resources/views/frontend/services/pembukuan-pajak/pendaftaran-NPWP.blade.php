@extends('layout.app')
@section('title', 'Pendaftaran Npwp | Lawgika - Konsultan Legal & Bisnis')
@section('meta_description', 'Layanan Pendaftaran Npwp terbaik dan terpercaya di Indonesia oleh Lawgika.co.id. Proses cepat, legal, dan aman untuk kebutuhan bisnis Anda.')
@section('meta_keywords', 'Pendaftaran Npwp, Jasa Pendaftaran Npwp, Konsultan Pendaftaran Npwp, Lawgika, Legalitas Usaha, Jasa Hukum Bisnis')
...
<section class="service-overview">
    <div class="container">
        <div class="section-header">
            ...
            <h2>Pendaftaran Nomor Pokok Wajib Pajak</h2>
            <p>Layanan pendaftaran NPWP untuk membantu individu dan perusahaan mendapatkan identitas perpajakan secara resmi</p>
        </div>
        <div class="service-grid">
            <div class="service-card fade-up" style="animation-delay: 0.1s">
                ...
                <h3>NPWP Orang Pribadi</h3>
                <p>Layanan pendaftaran NPWP untuk individu (karyawan, profesional, pengusaha) yang membutuhkan identitas perpajakan untuk berbagai keperluan administrasi dan kepatuhan pajak.</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> Pendaftaran NPWP karyawan</li>
                    <li><i class="bi bi-check-circle-fill"></i> NPWP untuk profesional & freelancer</li>
                    <li><i class="bi bi-check-circle-fill"></i> NPWP untuk pengusaha perorangan</li>
                    <li><i class="bi bi-check-circle-fill"></i> Aktivasi EFIN & akun DJP Online</li>
                </ul>
            </div>
            <div class="service-card fade-up" style="animation-delay: 0.2s">
                ...
                <p>Layanan pendaftaran NPWP untuk badan usaha (PT, CV, Yayasan, Koperasi) yang wajib memiliki NPWP sebagai identitas perpajakan perusahaan.</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> NPWP PT & CV</li>
                    <li><i class="bi bi-check-circle-fill"></i> NPWP Yayasan & Koperasi</li>
                    <li><i class="bi bi-check-circle-fill"></i> NPWP Bentuk Usaha Tetap (BUT)</li>
                    <li><i class="bi bi-check-circle-fill"></i> Aktivasi EFIN Badan</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="benefits-grid">
            <div class="benefit-card fade-up" style="animation-delay: 0.1s">
                ...
                <p>Pendaftaran NPWP ditangani oleh tim profesional, proses cepat tanpa perlu antri di Kantor Pajak.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.2s">
                <div class="benefit-number">2</div>
                <h4>Dokumen Lengkap</h4>
                <p>Kami bantu siapkan seluruh dokumen persyaratan dengan teliti untuk memastikan pengajuan diterima.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.3s">
                <div class="benefit-number">3</div>
                <h4>Aktivasi EFIN Sekaligus</h4>
                <p>Sekaligus bantu aktivasi EFIN dan pembuatan akun DJP Online untuk akses layanan pajak digital.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.4s">
                <div class="benefit-number">4</div>
                <h4>Konsultasi Pajak Gratis</h4>
                <p>Dapatkan konsultasi gratis seputar hak dan kewajiban perpajakan setelah memiliki NPWP.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
                ...
                <div class="break-content fade-up">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            ...
                            <p class="text-white-50 mb-0">Kredit, tender, paspor</p>
                        </div>
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            <h5 class="text-white mb-2">Bebas Tarif Tinggi</h5>
                            <p class="text-white-50 mb-0">Pajak lebih rendah</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="text-center">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=400&q=80" alt="NPWP Illustration" class="img-fluid rounded-4 shadow-lg" style="border: 4px solid rgba(255,255,255,0.2);">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="faq-grid">
            <div class="faq-item-modern">
                ...
                <div class="faq-answer-modern">
                    NPWP (Nomor Pokok Wajib Pajak) adalah identitas resmi wajib pajak yang diterbitkan oleh Direktorat Jenderal Pajak. NPWP penting untuk administrasi perpajakan, pengajuan kredit bank, pembuatan paspor, mengikuti tender, dan berbagai keperluan administratif lainnya.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                ...
                <div class="faq-answer-modern">
                    Setiap orang pribadi yang telah memiliki penghasilan di atas Penghasilan Tidak Kena Pajak (PTKP) wajib memiliki NPWP. Selain itu, seluruh badan usaha (PT, CV, Yayasan, dll) wajib memiliki NPWP sejak didirikan.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apa persyaratan pendaftaran NPWP Pribadi?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    Untuk karyawan: Fotokopi KTP dan Kartu Keluarga. Untuk pengusaha/profesional: Fotokopi KTP, KK, dan Surat Keterangan Usaha (SKU) atau bukti kegiatan usaha.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apa persyaratan pendaftaran NPWP Badan?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    Persyaratan NPWP Badan: Akta Pendirian, SK Kemenkumham, NPWP dan KTP Direktur/Pengurus, Surat Keterangan Domisili Usaha, dan bukti kepemilikan/sewa tempat usaha.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                ...
                <div class="faq-answer-modern">
                    Proses pembuatan NPWP umumnya memakan waktu 1-3 hari kerja setelah seluruh dokumen persyaratan lengkap dan diverifikasi. Kartu fisik NPWP akan dikirimkan melalui pos ke alamat terdaftar.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apa itu EFIN dan mengapa diperlukan?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    EFIN (Electronic Filing Identification Number) adalah kode identitas digital yang digunakan untuk mengakses layanan DJP Online, termasuk e-Filing, e-Billing, dan layanan perpajakan elektronik lainnya. Kami bantu aktivasi EFIN sekaligus saat pendaftaran NPWP.
                </div>
            </div>
        </div>
    </div>
