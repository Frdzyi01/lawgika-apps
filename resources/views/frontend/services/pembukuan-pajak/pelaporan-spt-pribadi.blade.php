...
<section class="service-overview">
    <div class="container">
        <div class="section-header">
            ...
            <h2>Pelaporan SPT Tahunan Orang Pribadi</h2>
            <p>Layanan pelaporan SPT Pribadi untuk membantu Anda memenuhi kewajiban perpajakan dengan mudah dan akurat</p>
        </div>
        <div class="service-grid">
            <div class="service-card fade-up" style="animation-delay: 0.1s">
                ...
                <h3>SPT Pribadi Karyawan</h3>
                <p>Layanan pelaporan SPT Tahunan bagi wajib pajak orang pribadi dengan penghasilan dari satu pemberi kerja (Formulir 1770 SS atau 1770 S).</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> Pelaporan SPT 1770 SS</li>
                    <li><i class="bi bi-check-circle-fill"></i> Pelaporan SPT 1770 S</li>
                    <li><i class="bi bi-check-circle-fill"></i> Perhitungan PPh Kurang/Lebih Bayar</li>
                    <li><i class="bi bi-check-circle-fill"></i> Bukti pelaporan elektronik</li>
                </ul>
            </div>
            <div class="service-card fade-up" style="animation-delay: 0.2s">
                ...
                <h3>SPT Pribadi Pengusaha/Profesional</h3>
                <p>Layanan pelaporan SPT Tahunan bagi wajib pajak orang pribadi yang memiliki penghasilan dari usaha, pekerjaan bebas, atau lebih dari satu sumber penghasilan (Formulir 1770).</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> Pelaporan SPT 1770</li>
                    <li><i class="bi bi-check-circle-fill"></i> Perhitungan Norma/Pembukuan</li>
                    <li><i class="bi bi-check-circle-fill"></i> Lampiran harta & kewajiban</li>
                    <li><i class="bi bi-check-circle-fill"></i> Konsultasi perencanaan pajak</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="benefits-grid">
            <div class="benefit-card fade-up" style="animation-delay: 0.1s">
                ...
                <h4>Akurat & Tepat Waktu</h4>
                <p>Pelaporan SPT dilakukan dengan perhitungan akurat dan disampaikan sebelum batas waktu untuk menghindari denda.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.2s">
                <div class="benefit-number">2</div>
                <h4>Proses Mudah & Cepat</h4>
                <p>Cukup berikan dokumen yang diperlukan, tim kami yang akan mengurus seluruh proses pelaporan hingga selesai.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.3s">
                <div class="benefit-number">3</div>
                <h4>Optimalkan Pajak</h4>
                <p>Kami bantu identifikasi potensi penghematan pajak yang sah sesuai peraturan perpajakan yang berlaku.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.4s">
                <div class="benefit-number">4</div>
                <h4>Konsultasi Gratis</h4>
                <p>Dapatkan konsultasi gratis seputar perpajakan pribadi dan perencanaan keuangan untuk masa depan.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
                ...
                <div class="break-content fade-up">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            ...
                            <p class="text-white-50 mb-0">Pelaporan tepat waktu</p>
                        </div>
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            <h5 class="text-white mb-2">Bukti Lapor Resmi</h5>
                            <p class="text-white-50 mb-0">Tanda terima elektronik</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="text-center">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=400&q=80" alt="SPT Illustration" class="img-fluid rounded-4 shadow-lg" style="border: 4px solid rgba(255,255,255,0.2);">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="faq-grid">
            <div class="faq-item-modern">
                ...
                <div class="faq-answer-modern">
                    Setiap wajib pajak orang pribadi yang memiliki NPWP wajib melaporkan SPT Tahunan, baik yang memiliki penghasilan di bawah PTKP (Penghasilan Tidak Kena Pajak) maupun di atasnya.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                ...
                <div class="faq-answer-modern">
                    Batas waktu pelaporan SPT Tahunan Orang Pribadi adalah paling lambat tanggal 31 Maret setiap tahunnya untuk tahun pajak sebelumnya.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apa sanksi jika terlambat atau tidak lapor SPT?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    Keterlambatan pelaporan SPT dikenakan denda sebesar Rp 100.000 untuk SPT Tahunan Orang Pribadi. Selain itu, wajib pajak juga dapat dikenakan sanksi administrasi lainnya jika terdapat pajak terutang yang belum dibayar.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                ...
                <div class="faq-answer-modern">
                    Dokumen yang diperlukan antara lain: Bukti Potong PPh 21 (Form 1721 A1/A2), NPWP, data harta dan kewajiban per akhir tahun, serta daftar tanggungan keluarga untuk perhitungan PTKP.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apa perbedaan formulir 1770 SS, 1770 S, dan 1770?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    1770 SS untuk penghasilan ≤ Rp 60 juta setahun dari satu pemberi kerja. 1770 S untuk penghasilan > Rp 60 juta setahun dari satu pemberi kerja. 1770 untuk penghasilan dari usaha/pekerjaan bebas atau lebih dari satu sumber penghasilan.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apakah bisa lapor SPT meskipun NPWP baru?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    Ya, wajib pajak yang baru memiliki NPWP tetap wajib melaporkan SPT Tahunan untuk tahun pajak bersangkutan, meskipun hanya untuk sebagian tahun pajak.
                </div>
            </div>
        </div>
    </div>
