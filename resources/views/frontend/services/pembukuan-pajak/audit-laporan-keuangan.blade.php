@extends('layout.app')
@section('title', 'Audit Laporan Keuangan | Lawgika - Konsultan Legal & Bisnis')
@section('meta_description', 'Layanan Audit Laporan Keuangan terbaik dan terpercaya di Indonesia oleh Lawgika.co.id. Proses cepat, legal, dan aman untuk kebutuhan bisnis Anda.')
@section('meta_keywords', 'Audit Laporan Keuangan, Jasa Audit Laporan Keuangan, Konsultan Audit Laporan Keuangan, Lawgika, Legalitas Usaha, Jasa Hukum Bisnis')
    ...
    <div class="container">
        ...
        <div class="service-grid">
            <div class="service-card fade-up" style="animation-delay: 0.1s">
                ...
                <h3>General Audit</h3>
                <p>Pemeriksaan menyeluruh atas laporan keuangan perusahaan untuk memberikan opini independen mengenai kewajaran penyajian laporan keuangan sesuai standar akuntansi yang berlaku.</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> Audit laporan keuangan tahunan</li>
                    <li><i class="bi bi-check-circle-fill"></i> Pemeriksaan kepatuhan PSAK</li>
                    <li><i class="bi bi-check-circle-fill"></i> Evaluasi sistem pengendalian internal</li>
                    <li><i class="bi bi-check-circle-fill"></i> Opini auditor independen</li>
                </ul>
            </div>
            <div class="service-card fade-up" style="animation-delay: 0.2s">
                ...
                <h3>Audit Khusus (Special Audit)</h3>
                <p>Pemeriksaan terbatas pada area tertentu sesuai kebutuhan spesifik perusahaan, seperti audit due diligence, audit investigatif, atau audit untuk tujuan tertentu lainnya.</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> Due diligence audit (akuisisi/merger)</li>
                    <li><i class="bi bi-check-circle-fill"></i> Audit investigatif (fraud detection)</li>
                    <li><i class="bi bi-check-circle-fill"></i> Audit kepatuhan (compliance audit)</li>
                    <li><i class="bi bi-check-circle-fill"></i> Agreed-upon procedures</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="benefits-grid">
            ...
            <div class="benefit-card fade-up" style="animation-delay: 0.1s">
                ...
                <h4>Auditor Profesional & Tersertifikasi</h4>
                <p>Tim auditor kami terdiri dari profesional berpengalaman dengan sertifikasi CPA dan terdaftar di OJK serta Kemenkeu.</p>
            </div>

            <div class="benefit-card fade-up" style="animation-delay: 0.2s">
                <div class="benefit-number">2</div>
                <h4>Laporan Akurat & Terpercaya</h4>
                <p>Kami memastikan laporan keuangan Anda disajikan secara wajar dan bebas dari salah saji material.</p>
            </div>

            <div class="benefit-card fade-up" style="animation-delay: 0.3s">
                <div class="benefit-number">3</div>
                <h4>Kepatuhan Standar Akuntansi</h4>
                <p>Audit dilakukan sesuai Standar Profesional Akuntan Publik (SPAP) dan PSAK terbaru.</p>
            </div>

            <div class="benefit-card fade-up" style="animation-delay: 0.4s">
                <div class="benefit-number">4</div>
                <h4>Rekomendasi Perbaikan</h4>
                <p>Kami memberikan management letter berisi rekomendasi untuk meningkatkan sistem pengendalian internal perusahaan.</p>
            </div>
        ...
        <div class="row align-items-center">
                ...
                <div class="break-content fade-up">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            ...
                            <p class="text-white-50 mb-0">Dipercaya stakeholder</p>
                        </div>
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            <h5 class="text-white mb-2">Sesuai Regulasi</h5>
                            <p class="text-white-50 mb-0">Memenuhi ketentuan OJK & Pasar Modal</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="text-center">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=400&q=80" alt="Audit Illustration" class="img-fluid rounded-4 shadow-lg" style="border: 4px solid rgba(255,255,255,0.2);">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="faq-grid">
            <div class="faq-item-modern">
                ...
                <div class="faq-answer-modern">
                    Audit laporan keuangan adalah proses pemeriksaan independen atas laporan keuangan perusahaan untuk memberikan opini mengenai kewajaran penyajian laporan keuangan sesuai dengan standar akuntansi yang berlaku.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                ...
                <div class="faq-answer-modern">
                    Perusahaan membutuhkan audit untuk berbagai keperluan seperti: persyaratan regulasi (OJK, Pasar Modal), pengajuan kredit bank, proses due diligence (merger/akuisisi), atau untuk meningkatkan kredibilitas di mata stakeholder.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                ...
                <div class="faq-answer-modern">
                    Durasi audit bervariasi tergantung ukuran perusahaan, kompleksitas transaksi, dan kesiapan data. Umumnya berkisar antara 2 minggu hingga 2 bulan untuk audit tahunan.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                ...
                <div class="faq-answer-modern">
                    Dokumen yang diperlukan antara lain: laporan keuangan, buku besar, rekening koran, faktur pajak, kontrak/perjanjian, bukti kepemilikan aset, dan dokumen pendukung transaksi lainnya.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apakah hasil audit bersifat rahasia?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    Ya, kami sangat menjaga kerahasiaan data klien. Seluruh informasi yang diperoleh selama proses audit dilindungi oleh kode etik profesi akuntan publik dan perjanjian kerahasiaan.
                </div>
            </div>
            <div class="faq-item-modern">
                <div class="faq-question-modern">
                    Apakah Lawgika terdaftar sebagai Akuntan Publik?
                    <i class="bi bi-chevron-down"></i>
                </div>
                <div class="faq-answer-modern">
                    Ya, Lawgika bekerja sama dengan Kantor Akuntan Publik (KAP) yang terdaftar resmi di Kementerian Keuangan dan Otoritas Jasa Keuangan (OJK), sehingga laporan audit kami sah dan diakui secara hukum.
                </div>
            </div>
        </div>
    </div>
