@extends('layout.app')
@section('title', 'Layanan Payroll | Lawgika - Konsultan Legal & Bisnis')
@section('meta_description', 'Layanan Layanan Payroll terbaik dan terpercaya di Indonesia oleh Lawgika.co.id. Proses cepat, legal, dan aman untuk kebutuhan bisnis Anda.')
@section('meta_keywords', 'Layanan Payroll, Jasa Layanan Payroll, Konsultan Layanan Payroll, Lawgika, Legalitas Usaha, Jasa Hukum Bisnis')
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <div class="text-center">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=400&q=80" alt="Payroll Illustration" class="img-fluid rounded-4 shadow-lg" style="border: 4px solid rgba(255,255,255,0.2);">
                </div>
            </div>
        </div>
    </div>
