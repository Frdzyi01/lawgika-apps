@extends('layout.app')
@section('title', 'Jasa Pengurusan Pkp & Konsultan Pajak | Lawgika')
@section('meta_description', 'Layanan Pengurusan Pkp profesional untuk mengurus administrasi dan kepatuhan pajak perusahaan Anda dengan tepat waktu.')
@section('meta_keywords', 'Pengurusan Pkp, Konsultan Pajak, Jasa Pembukuan, Lapor Pajak, Tax Accounting Lawgika')
...
<section class="service-overview">
    <div class="container">
        <div class="section-header">
            ...
            <h2>Pengukuhan Pengusaha Kena Pajak (PKP)</h2>
            <p>Layanan pengurusan PKP untuk membantu perusahaan Anda memenuhi kewajiban perpajakan secara resmi</p>
        </div>
        <div class="service-grid">
            <div class="service-card fade-up" style="animation-delay: 0.1s">
                ...
                <h3>Pengukuhan PKP Baru</h3>
                <p>Layanan pendaftaran dan pengukuhan PKP bagi perusahaan yang telah memenuhi syarat sebagai Pengusaha Kena Pajak, termasuk konsultasi persyaratan dan pendampingan proses.</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> Pengecekan kelengkapan dokumen</li>
                    <li><i class="bi bi-check-circle-fill"></i> Pengajuan permohonan PKP</li>
                    <li><i class="bi bi-check-circle-fill"></i> Pendampingan verifikasi KPP</li>
                    <li><i class="bi bi-check-circle-fill"></i> Aktivasi akun PKP & e-Faktur</li>
                </ul>
            </div>
            <div class="service-card fade-up" style="animation-delay: 0.2s">
                ...
                <h3>Perubahan Data PKP</h3>
                <p>Layanan perubahan data PKP seperti perubahan alamat, penanggung jawab, atau data lainnya agar status PKP perusahaan tetap valid dan sesuai dengan kondisi terkini.</p>
                <ul class="service-features">
                    <li><i class="bi bi-check-circle-fill"></i> Perubahan alamat usaha</li>
                    <li><i class="bi bi-check-circle-fill"></i> Perubahan penanggung jawab</li>
                    <li><i class="bi bi-check-circle-fill"></i> Pemutakhiran data PKP</li>
                    <li><i class="bi bi-check-circle-fill"></i> Pencabutan PKP (jika diperlukan)</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="benefits-grid">
            <div class="benefit-card fade-up" style="animation-delay: 0.1s">
                ...
                <h4>Proses Cepat & Terjamin</h4>
                <p>Pengurusan PKP ditangani oleh tim profesional yang berpengalaman, memastikan proses berjalan lancar dan cepat.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.2s">
                <div class="benefit-number">2</div>
                <h4>Dokumen Lengkap & Akurat</h4>
                <p>Kami bantu siapkan seluruh dokumen persyaratan dengan teliti untuk menghindari penolakan permohonan.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.3s">
                <div class="benefit-number">3</div>
                <h4>Pendampingan Verifikasi</h4>
                <p>Tim kami mendampingi Anda saat proses verifikasi oleh petugas KPP untuk memastikan kelancaran.</p>
            </div>
            <div class="benefit-card fade-up" style="animation-delay: 0.4s">
                <div class="benefit-number">4</div>
                <h4>Konsultasi PPN Gratis</h4>
                <p>Dapatkan konsultasi gratis seputar kewajiban PPN setelah resmi menjadi PKP.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
                ...
                <div class="break-content fade-up">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            ...
                            <p class="text-white-50 mb-0">Dapat menerbitkan e-Faktur</p>
                        </div>
                        <div class="bg-white bg-opacity-10 rounded-4 p-4" style="backdrop-filter: blur(10px);">
                            <h5 class="text-white mb-2">Kredit PPN Masukan</h5>
                            <p class="text-white-50 mb-0">Optimalkan beban pajak</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="text-center">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=400&q=80" alt="PKP Illustration" class="img-fluid rounded-4 shadow-lg" style="border: 4px solid rgba(255,255,255,0.2);">
                </div>
            </div>
        </div>
    </div>
