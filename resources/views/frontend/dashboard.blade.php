...
@section('meta_description', 'Lawgika menyediakan jasa pendirian PT, PT Perorangan, CV, Virtual Office, HAKI, OSS, PKP, dan legalitas usaha terpercaya di Indonesia')
...
<style>
  ...
  /* ---- Background: FULL LAYAR TANPA HITAM ---- */
  .hero-slide-bg {
    position: absolute;
    inset: 0;
  ...
  /* ---- Pagination dots (dalam slider) ---- */
  .hero-pagination {
    position: absolute;
    bottom: 120px;
    /* Naikkan agar tidak ketutupan Quick Access */
    left: 0;
    right: 0;
    z-index: 5;
    display: flex;
  ...
  /* ===== QUICK ACCESS ICONS - Absolute di dalam 1 layar ===== */
  .hero-quick-access {
    position: absolute;
    bottom: 20px;
    left: 0;
  ...
  .quick-access-wrapper {
    ...
    border: 1px solid rgba(240, 228, 232, 0.8);
  ...
  .quick-access-icon {
    ...
    border: 1px solid rgba(158, 28, 34, 0.1);
    box-shadow: 0 8px 15px rgba(158, 28, 34, 0.05);
  }
  ...
  .quick-access-item:hover .quick-access-icon {
    background: #9e1c22;
    color: #ffffff;
    box-shadow: 0 12px 25px rgba(158, 28, 34, 0.25);
    border-color: #D4AF37;
  }
        ...
        modalContent.innerHTML = `
                 ...
                 <div class="modal-event-body">
                     ...
                     <div class="modal-buttons">
                         <a href="https://wa.me/6281112088600?text=Halo%20Lawgika,%20saya%20ingin%20mendaftar%20event%20${encodeURIComponent(event.nama_event)}" target="_blank" class="btn-daftar"><i class="fas fa-ticket-alt"></i> Daftar Sekarang</a>
