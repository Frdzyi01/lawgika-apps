@extends('layout.app')
@section('title', 'Jasa Pendirian Pt Perorangan Professional | Lawgika')
@section('meta_description', 'Butuh jasa Pendirian Pt Perorangan Professional? Lawgika siap membantu pengurusan legalitas perusahaan Anda dengan proses cepat dan harga transparan.')
@section('meta_keywords', 'Pt Perorangan Professional, Jasa Pt Perorangan Professional, Konsultan Pt Perorangan Professional, Lawgika, Legalitas Usaha, Jasa Hukum Bisnis')
...
<style>
    ...
    .order-card {
        background: #fff;
        border-radius: 20px;
        box-shadow: 0 8px 30px rgba(78, 5, 22, .07);
    ...
    .file-upload-box.border-danger-upload {
    ...
    .btn-order-submit:hover {
        ...
        box-shadow: 0 8px 25px rgba(78, 5, 22, .35);
        color: #fff;
    }
