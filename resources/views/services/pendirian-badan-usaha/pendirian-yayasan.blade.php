        ...
        <div class="page-heading">
            <div class="page-header-left">
                ...
                <ul
                    ...
                    <li>Layanan Pendirian Yayasan</li>
                </ul>
            </div>
            <div
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="section-title">
                            <span class="wow fadeInUp">Jasa Pendirian Yayasan</span>
                            <h2
                                class="wow fadeInUp"
                                data-wow-delay=".3s">
                                Jasa Konsultan Legalitas & Pendirian Yayasan Terpercaya.
                            </h2>
                        </div>
                        <p
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                <div class="pricing-items style-2">
                    <h6 class="top-text">PENDIRIAN YAYASAN</h6>
                    <div class="pricing-header-2">
                        <h2>Rp 5.000.000</h2>
                    </div>
                    <ul class="pricing-list">
                        <li><span><i class="fa-solid fa-check"></i> Pengecekan Nama Yayasan</span></li>
                        <li><span><i class="fa-solid fa-check"></i> Pemesanan Nama Yayasan</span></li>
                        <li><span><i class="fa-solid fa-check"></i> Akta Pendirian Yayasan</span></li>
                    ...
                    <p class="mt-4 text-start">Layanan Pendirian Yayasan area tertentu (Jabodetabek/Medan/Batam)</p>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                <div class="pricing-items style-2 active">
                    <h6 class="top-text">PENDIRIAN YAYASAN + VO</h6>
                    <div class="pricing-header-2">
                        <h2>Rp 7.500.000</h2>
                    </div>
                    <ul class="pricing-list">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                <div class="pricing-items style-2">
                    <h6 class="top-text">PENDIRIAN YAYASAN + VO + CALL HANDLING</h6>
                    <br>
                    <div class="pricing-header-2">
                        <h2>Rp 10.000.000</h2>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="faq-content">
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                Pertanyaan Seputar Legalitas & Pendirian Yayasan
                            </h2>
                        </div>
                            ...
                            <div class="accordion" id="accordion">
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Proses pendirian Yayasan biasanya memakan waktu sekitar 3 sampai 7 hari kerja setelah semua dokumen persyaratan lengkap dan nama Yayasan telah disetujui.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div id="faq2" class="accordion-collapse show" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Secara umum, persyaratan dokumen meliputi fotokopi e-KTP dan NPWP para pendiri (susunan terdiri dari Pembina, Pengurus, dan Pengawas Yayasan), surat keterangan domisili usaha, serta surat pernyataan kekayaan awal yayasan.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".7s">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" aria-expanded="false" aria-controls="faq3">
                                            Apakah Yayasan bisa didirikan tanpa NPWP yayasan?
                                        </button>
                                    </h5>
                                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Tidak bisa. NPWP yayasan menjadi salah satu syarat mutlak setelah Akta Notaris diterbitkan agar Yayasan bisa sah beroperasi sebagai badan hukum. Kami akan membantu pengurusannya.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-delay=".7s">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq4" aria-expanded="false" aria-controls="faq4">
                                            Apa bedanya PT dan Yayasan?
                                        </button>
                                    </h5>
                                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            Perbedaan mendasar adalah PT merupakan badan usaha yang berorientasi pada profit atau keuntungan, sedangkan Yayasan didirikan untuk tujuan sosial, keagamaan, atau kemanusiaan, dan tidak berfokus pada pembagian keuntungan kepada pengurusnya.
                                        </div>
                                    </div>
                                </div>
                            </div>
