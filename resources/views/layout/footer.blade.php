    ...
    >
      <div class="footer-widgets-wrapper">
        <div class="container">
          <div class="row">
            ...
            <div
              class="col-xl-2 col-lg-4 col-md-6 ps-lg-4"
            >
              <div class="single-footer-widget">
                <div class="widget-head">
                  <h3>Dukungan</h3>
            ...
            <div
              class="col-xl-3 col-lg-4 col-md-6 ps-lg-4"
            >
              <div class="single-footer-widget">
                <div class="widget-head">
                  <h3>Newsletter</h3>
                ...
                <div class="footer-content">
                  <p>
                    Daftar untuk mendapatkan update hukum dan bisnis terbaru dari kami.
                  </p>
      ...
      <div class="footer-bottom">
        <div class="container">
          ...
          >
            <p>
              © Hak Cipta 2024 oleh <a href="#">Lawgika Bisnis Indonesia</a>
            </p>
            <ul class="brand-logo">
              <li>
