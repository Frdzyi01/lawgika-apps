    ...
    <div class="cal-page-header">
        <div>
            <h1 class="cal-page-title">
                <i class="fa-solid fa-calendar-days text-primary"></i> Kalender Reservasi Meeting Room
            </h1>
            <p class="cal-page-subtitle">Visualisasi jadwal penggunaan Ruang Meeting dalam tampilan mingguan 24 Jam.</p>
        </div>
        <div class="d-flex gap-2 flex-wrap">
            <a href="{{ url('admin/meeting-room') }}" class="btn btn-outline-secondary btn-sm px-3 py-2 rounded-3 fw-bold" style="font-size:0.85rem;">
...
<script>
(function() {
    const EVENTS_URL  = "{{ url('admin/meeting-room/calendar-events') }}";
    const HOURS_START = 0;
    const HOURS_END   = 23;
    ...
    function autoScrollToCurrentTime() {
        ...
        const targetHour = curHour >= 7 ? Math.max(0, curHour - 1) : 7;
    ...
    window.calShowPopover = function(ev, targetEl) {
        ...
        popover.innerHTML = `
            <div class="cal-popover-header">
                ...
                <div class="cal-popover-room"><i class="fa-solid fa-people-roof me-1"></i>${escHtml(ev.room_name)}</div>
            </div>
            <div class="cal-popover-body">
                ...
                ${ev.keperluan ? `
                <div class="cal-popover-row">
                    <div class="cal-popover-icon"><i class="fa-solid fa-briefcase"></i></div>
                    <div>
                        <div class="cal-popover-label">Keperluan</div>
                        <div class="cal-popover-value">${escHtml(ev.keperluan)}</div>
                    </div>
                </div>` : ''}
                <div class="cal-popover-row">
