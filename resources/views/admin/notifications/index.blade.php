...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <ion-icon name="notifications-outline" class="align-middle"></ion-icon> Semua Notifikasi Transaksi
        </h1>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4">Belum ada riwayat transaksi atau notifikasi.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
